                        ...
                        <ul class="navbar-nav header-right"></ul>
                            ...
                            <!-- <li class="nav-item dropdown header-profile"> -->
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="../../../views/app-profile.html" class="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        <span class="ml-2">Profile </span>
                                    </a>
                                    <a href="../../../views/email-inbox.html" class="dropdown-item ai-icon">
                                        <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                        <span class="ml-2">Inbox </span>
                                    </a>
                                    <a href="../../../views/page-login.html" class="dropdown-item ai-icon">
            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="../../../views/form-element.html">Form Elements</a></li>
                            <li><a href="../../../views/form-wizard.html">Wizard</a></li>
                            <li><a href="../../../views/form-editor-summernote.html">Summernote</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <!-- <ul aria-expanded="false">
                            <li><a href="../../../views/page-register.html">Register</a></li>
                            <li><a href="../../../views/page-login.html">Login</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Error</a>
                                <ul aria-expanded="false">
                                    <li><a href="../../../views/page-error-400.html">Error 400</a></li>
                                    <li><a href="../../../views/page-error-403.html">Error 403</a></li>
                                    <li><a href="../../../views/page-error-404.html">Error 404</a></li>
                                    <li><a href="../../../views/page-error-500.html">Error 500</a></li>
                                    <li><a href="../../../views/page-error-503.html">Error 503</a></li>
                                </ul>
                            </li>
                            <li><a href="../../../views/page-lock-screen.html">Lock Screen</a></li>
                        </ul>
                    </li>
                </ul>
										...
										<form method="post" action="Actu2.php?id=<?php echo $id ?>&NumeroIdentificacion=<?php echo $numeroIdentificacion?>">
											<div class="form-row">											
												...
												<div class="form-group col-md-6">
													...
													<input required type="text" class="form-control" id="nomyApe" name="nomyApe"placeholder="Ingrese  Su Apellido Completo"value="<?php echo $nombreCliente; echo(" ") ;echo $apellidoCliente ?>"disabled>
													<input type="hidden"  class="form-control" id="nomyApe" name="nomyApe"placeholder="Ingrese  Su Apellido Completo"value="<?php echo $apellidoCliente ?>">
												</div>
												<div class="form-group col-md-6">
											...
											<input type="button" class="btn btn-warning" style="background-color: #FF9900; color: white;text-align:center;"value="Regresar" onclick="location.href='../../../views/mostrarClientes.php'"/>	
