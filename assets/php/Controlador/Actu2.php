				...
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="../../../views/../../../views/inicioRecepcionista.php">Bienvenido</a></li>
								...
								<div class="card-body">
									<div class="basic-form">
										<form method="post" action="Actu2.php?id=<?php echo $id ?>&NumeroIdentificacion=<?php echo $numeroIdentificacion?>">
											...
											<input type="button" class="btn btn-warning" style="background-color: #FF9900; color: white;text-align:center;"value="Regresar" onclick="location.href='../../../views/mostrarInstructores.php'"/>	
