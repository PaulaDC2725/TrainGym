...
if (isset($filas)) {    
  ...
  foreach ($filas as $fila){
	$tabla.='<tr class="limitada" scope="row">';
	  ...
	  $botonhab='<a href="habCli.php?NumeroIdentificacion='.$fila['NumeroIdentificacion'].'&id='.$fila['idCliente'].'" class="btn btn-success shadow btn-xs sharp"><i class="fa fa-check"></i></a>';
	  $tabla.='<td>
	  				<div class="d-flex">
					  '.$botonhab.'
	  				</div>												
        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="javascript:void(0)">Habilitar</a></li>
                ...
                <div class="row">
					<div class="col-12">
                        <div class="card">
							...
							<h4 class="card-title">Información de los Clientes inhabilitados</h4>
                            </div>
                            <div class="card-body">
