...
if (isset($_GET['filtroCol']) && isset($_GET['valor'])) {
  $filas = $consultasInstructor->consultarInstructorFiltrados($_GET['filtroCol'],$_GET['valor']);
}else{
...
<tbody>
  <tr>
    <form action="" method="GET" id="form">        
      ...
      <td>
        <a href="inhainst.php"><input type="button" class="btn btn-warning" value="Limpiar Busqueda"></a>
      </td>
    </form>         
    <td>
