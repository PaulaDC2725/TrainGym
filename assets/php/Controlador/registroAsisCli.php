...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-Dark">
		<div class="container">
			<center><a href="../../../views/inicioCliente.php?NumeroIdentificacion=<?php echo $numeroIdentificacion?>">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				<li class="nav-item"><a class="nav-link" href="../../../views/inicioCliente.php?NumeroIdentificacion=<?php echo $numeroIdentificacion?>">Regresar</a></li>
			</ul>
		</div>
	</div>
</nav>
			...
			<div class="row">
				...
				<div class="col-md-6 contents">
					<div class="row justify-content-center">
						...
						<form action="registroAsisCli.php" method="post">
