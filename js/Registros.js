function validarForm1() {
  let tipoDocumento = document.getElementById('tipoDocumentoCli').value;
    ...
    if ((tipoDocumento=="")||(numeroIdentificacion == "") || (correoCliente == "") || (Confcontra == "") ||(nombreCliente == "") || (apellidoCliente == "") || (fechaNacimiento == "") || (telefonoCliente == "") || (contraseñaCliente == "") || (correoCliente == ""))
    {
