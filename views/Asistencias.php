                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Seleccione el tipo de usuario</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card-content">                                            
											<ol class="dd-list">													
													...
													<div onclick="location.href='mostrarAsistencias.php'" style="height: 90px; font-size:35px; text-align: center" class="dd-handle"><br>Clientes</div>
												</li> 
											</ol>                                                
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-content">
											<ol class="dd-list">
												<li class="dd-item" data-id="13">
													<div onclick="location.href='mostrarAsistenciasInst.php'" style="height: 90px; font-size:35px; text-align: center" class="dd-handle"><br>Instructores</div>
												</li>
											</ol>
                                        </div>
                                    </div>
