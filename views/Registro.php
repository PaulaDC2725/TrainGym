...
<div class="card border-dark mb-3" style="max-width: 18rem; border: black 2px solid;">
  ...
  <div class="card-body">
    <b class="card-text" >- Datos Personales</b>
    <br>
   <center> <b class="card-text" >----</b></center>
  </div>
  </div>
</div>
<div class="col-sm-3">
<div class="card border-dark mb-3" style="max-width: 18rem; border: black 2px solid;">
  ...
  <div class="card-body">
    <b class="card-text" >- Elegir Metodología</b>
    <br>
     <center><b class="card-text" >----</b></center>
  </div>
  </div>
...
<div class="card border-dark mb-3" style="max-width: 18rem; border: black 2px solid;">
  ...
  <div class="card-body">
    <b class="card-text" >- Suscripción</b>
    <br>
   <center><b class="card-text" >----</b> </center>
  </div>
  </div>
...
<div class="card border-dark mb-3" style="max-width: 18rem; border: black 2px solid;">
  ...
  <div class="card-body">
    <b class="card-text" >- Ficha Antropométrica</b>
    <br>
    <b class="card-text" >- Descripción Médica</b>
  </div>
  </div>
</div>
<br>
