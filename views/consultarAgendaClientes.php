  ...
  if (isset($filas)) {    
    ...
    foreach ($filas as $fila){
      ...
      $tabla.='<tr class="limitada" scope="row">';
        ...
        $botonAgenda='<a href="consultarAgendaClientes2.php?NumeroIdentificacion='.$fila['NumeroIdentificacion'].'" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-eye"></i></a>';
