...
if (!isset($numDoc) || $rolRec != 1 ) {
  ...
  if (isset($filas)) {    
    ...
    foreach ($filas as $fila){
      $botonAgenda='<a href="consultarAgendaClientes2.php?NumeroIdentificacion='.$fila['NumeroIdentificacion'].'"><input type="button" class="btn btn-warning" value="Consultar Agenda"></a>';
      $tabla.='<tr class="limitada" scope="row">';
        ...
        $tabla.='<center><td class="row_buttons">'.$botonAgenda.'</td></center>';
      $tabla.='</tr>';
...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <div class="container">
		...
		font-weight: 1000;
		color: black; "> Información de la agenda por clientes</h1>
		</div>
  ...
  <tbody>
    <tr>
      <form action="" method="GET" id="form">        
        ...
        <td>
          <a href="consultarAgendaClientes.php"><input type="button" class="btn btn-warning" value="Limpiar Busqueda"></a>
        </td>
      </form>         
      <td>
