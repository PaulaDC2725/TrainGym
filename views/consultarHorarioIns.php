...
require_once('../assets/php/Modelo/class.consulta.instructor.php');
  ...
  if (isset($numDoc) && $rol == 2) {
      ...
      {
        $numeroIdentificacion=$fila1['NumeroIdentificacion']; 
          $nombreInstructor = $fila1['nombreInstructor'];   
                ...
                <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Información de la agenda del instructor <?php echo $nombreInstructor;?></h4>
                            </div>
                            <div class="card-body">
