...
<center><h1 margin: 0,padding: 0 0 20px, text-align: center, font-size: 22px>Series de ejercicio: Aumentar masa corporal</h1></center>
  <br>
  <br>
  <div class="row">
  <div class="col-sm-7">
  <div class="container">
			<form class="box" method="post" action="../Assets/php/Controlador/registrarSeries.php?NumeroIdentificacion=<?php echo $numeroIdentificacion; ?>" >
                ...
                <div class="form-group">
    				...
    				<textarea class="form-control" id="exampleFormControlTextarea1" name="desc" rows="5" placeholder="*Ingrese la descripción del ejercicio para Aumentar masa corporal*"></textarea>
  				</div>
				<br>
