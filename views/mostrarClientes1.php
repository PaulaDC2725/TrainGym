...
require_once('../assets/php/Modelo/class.consulta.cliente.php');
  ...
  if (isset($filas)) {    
    ...
    //   $tabla.='<center><td class="row_buttons">'.$botonEditar.' '.$boton.'</td></center>';
	    $tabla.='</tr>';
	//  <a href="../../assets/php/Controlador/inhaCli.php?id='.$fila['idCliente'].'&NumeroIdentificacion='.$fila['NumeroIdentificacion'].'"><input type="button" class="btn btn-danger" value="Inhabilitar"></a>' <a href="actualizarCliente.php?id='.$fila['NumeroIdentificacion'].'"><input type="button" class="btn btn-warning" value="Actualizar"></a>'
	// <a href="suscripcion.php?id='.$fila['NumeroIdentificacion'].'"><input type="button" class="btn btn-warning" value="Ver Suscripcion"></a>';<a href="Ficha_Antropo.php?id='.$fila['NumeroIdentificacion'].'"><input type="button" class="btn btn-danger" value="Ver Ficha"></a>
     }  
 }
?>
<!DOCTYPE html>
										...
										<!-- <tr>
                                                ...
                                                <td>
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a class="dropdown-item" href="#">Ficha Antropométrica</a>
