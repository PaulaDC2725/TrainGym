<?php
  ...
  if (isset($filas)) {    
    ...
    foreach ($filas as $fila){
      $botonFicha='<a href="Ficha_Antropo.php?id='.$fila['NumeroIdentificacion'].'"><input type="button" class="btn btn-danger" value="Ver Ficha"></a>';
      $botonSuscripcion='<a href="suscripcion.php?id='.$fila['NumeroIdentificacion'].'"><input type="button" class="btn btn-warning" value="Ver Suscripcion"></a>';
      $tabla.='<tr class="limitada" scope="row">';
        ...
        $tabla.='<center><td class="row_buttons">'.$botonFicha.' '.$botonSuscripcion.'</td></center>';
      $tabla.='</tr>';
  ...
  <tbody>
    <tr>
      <form action="" method="GET" id="form">        
        ...
        <td>
          <a href="mostrarClientes1.php"><input type="button" class="btn btn-warning" value="Limpiar Busqueda"></a>
        </td>
      </form>         
      <td>
