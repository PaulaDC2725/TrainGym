  ...
  if (isset($filas)) {    
    ...
    foreach ($filas as $fila){
      ...
      $tabla.='<tr class="limitada" scope="row">';
        ...
        $botonhab='<a href="../assets/php/Controlador/habCli.php?NumeroIdentificacion='.$fila['NumeroIdentificacion'].'&id='.$fila['idCliente'].'"><input type="button" class="btn btn-info" value="Habilitar"></a>';
