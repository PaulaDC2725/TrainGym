...
if (isset($filas)) {    
  ...
  foreach ($filas as $fila){
	...
	//<a href="../../assets/php/Controlador/habCli.php?NumeroIdentificacion='.$fila['NumeroIdentificacion'].'&id='.$fila['idCliente'].'"><input type="button" class="btn btn-info" value="Habilitar"></a> <center><td class="row_buttons">'.$botonhab.'</td></center>
   }  
}
                                    ...
                                    <table id="example3" class="display min-w850">
										...
										<?php echo $tabla;?>
											...
											<!-- <tr>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="#" class="btn btn-success shadow btn-xs sharp"><i class="fa fa-check"></i></a>
													</div>												
												</td>												
                                            </tr>
                                            <tr>
