<?php
  ...
  if (isset($filas)) {    
    ...
    foreach ($filas as $fila){
      $boton='<a href="../assets/php/Controlador/habIns.php?id='.$fila['idInstructor'].'&NumeroIdentificacion='.$fila['NumeroIdentificacion'].'"><input type="button" class="btn btn-info" value="Habilitar"></a>';
