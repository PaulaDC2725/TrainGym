...
if (isset($filas)) {    
  ...
  foreach ($filas as $fila){
	$boton='<a href="AgendarIns.php?NumeroIdentificacion='.$fila['NumeroIdentificacion'].'" class="btn btn-success shadow btn-xs sharp"><i class="fa fa-check"></i></a>';
