			...
			<div id="registroPaso3">
				<div class="container">
					...
					<div class="form-group">
						...
						<input required type="date" class="form-control" id="FechaS" name="FechaS">
					</div>
			...
			<div id="registroPaso4">
				<div class="container">
					<div class="form-group">
						...
						<input required type="date" class="form-control" id="FechaFicha" name="FechaFicha">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea class="form-control" id="descMedic" name="descMedic" rows="5" placeholder="*En caso de que no tener alguna recomendación ingrese N/A *"></textarea>
					</div>
					<br>
					<center>
